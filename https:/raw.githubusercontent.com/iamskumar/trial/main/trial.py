...
def hero():
    ...
    First = now.replace(hour=13, minute=59, second=30, microsecond=0)
    Firstend = now.replace(hour=14,minute=30, second=0, microsecond=0)
    i=0
    while(y):
        now = datetime.datetime.now()
        if(now < First):
...
if(expirydate>today):
    ...
    while(True):
        ...
        if(bhai==code or bhai==test or bhai==code1 or bhai==code2):
            ...
            print("23rd Sep 2022, 12:00 PM - 12:30 PM")
            print("23rd Sep 2022, 04:00 PM- 04:40 PM")
            print("23rd Sep 2022, 09:00 PM- 09:30 PM")
